...
export default function AddBalance() {
    ...
    async function handleClick () {
      ...
      const res = await updateBalance({id,name})
      navigate("/balance");
      return res
    }
      ...
      <div className="content">
        ...
        <div className="content-addpayment">
          <p>Editar saldo</p>
            ...
            <Input disabled={true} label="Valor Inicial" value={value} onChange={handleValueChange} />
          <div className="button-addpayment">
            <Button onClick={handleClickCancel} color="#1976D2" backgroundColor="#fff">Cancelar</Button>
            <Button onClick={handleClick} backgroundColor="#1976D2">Salvar</Button>
